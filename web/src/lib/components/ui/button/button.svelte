	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				warning: "bg-warning/10 hover:bg-warning/20 focus-visible:ring-warning/20 dark:focus-visible:ring-warning/40 dark:bg-warning/20 text-warning-foreground focus-visible:border-warning/40 dark:hover:bg-warning/30",
