...
<svelte:head>
	<title>{surname} | Browse Surnames | My Family</title>
</svelte:head>

<div class="surname-detail-page">
	<header class="page-header">
		<nav class="breadcrumb">
			<a href="/browse/surnames">Browse Surnames</a>
			<span class="separator">/</span>
			<span class="current">{surname}</span>
		</nav>
		<h1>People with surname "{surname}"</h1>
		{#if total > 0}
	...
	{:else if persons.length === 0}
		<div class="empty">
			...
			<a href="/browse/surnames" class="back-link">Back to surname browser</a>
		</div>
	{:else}
